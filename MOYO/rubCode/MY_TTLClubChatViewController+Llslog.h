...
@interface MY_TTLClubChatViewController (Llslog)
- (void)broadCastArrayLlslog:(NSString *)llslog;
- (void)viewDidLoadLlslog:(NSString *)llslog;
- (void)addNewPwopleComeViewLlslog:(NSString *)llslog;
- (void)receiceBroadCastNotication:(NSNotification*)notic llslog:(NSString *)llslog;
- (void)addbroadcastViewLlslog:(NSString *)llslog;
- (void)broadCastViewLlslog:(NSString *)llslog;
- (void)updateClubModel:(NSNotification*)uinf llslog:(NSString *)llslog;
...
- (void)loadMessageLlslog:(NSString *)llslog;
...
- (void)BangDanBtnBtnClickLlslog:(NSString *)llslog;
...
- (void)BPBtnButtonClick1:(NSString *)furl Withid:(NSString *)uid llslog:(NSString *)llslog;
- (void)BPBtnButtonClick:(UIButton*)sender llslog:(NSString *)llslog;
- (void)inviteButtonClickLlslog:(NSString *)llslog;
- (void)BtnClick:(UIButton *)btn withBPView:(MY_XTUserBPView *)pView llslog:(NSString *)llslog;
...
- (void)PAYSuccess:(NSNotification *)notification llslog:(NSString *)llslog;
- (void)GetBPLlslog:(NSString *)llslog;
- (void)addBaP:(NSDictionary *)dic llslog:(NSString *)llslog;
- (void)usePhonePhotoAndCameraLlslog:(NSString *)llslog;
- (void)setchatTooBarSubViewLlslog:(NSString *)llslog;
- (void)messageViewController:(EaseMessageViewController *)viewController
                           modelForMessage:(EMMessage *)message llslog:(NSString *)llslog;
- (void)messageViewController:(UITableView *)tableView cellForTimeString:(NSString *)timeString llslog:(NSString *)llslog;
- (void)messageViewController:(EaseMessageViewController *)viewController didReceiveMessage:(EMMessage *)message llslog:(NSString *)llslog;
...
- (void)hongBaoDetailSelected:(NSDictionary*)dic llslog:(NSString *)llslog;
- (void)grabRedPacket:(id<IMessageModel>)model llslog:(NSString *)llslog;
- (void)messageViewController:(EaseMessageViewController *)viewController
        didSelectMessageModel:(id<IMessageModel>)messageModel llslog:(NSString *)llslog;
- (void)messageViewController:(EaseMessageViewController *)viewController
  didSelectAvatarMessageModel:(id<IMessageModel>)messageModel llslog:(NSString *)llslog;
- (void)messageViewController:(EaseMessageViewController *)viewController didLongPassSelectAvatarMessageModel:(id<IMessageModel>)messageModel llslog:(NSString *)llslog;
- (void)LongPoint:(UILongPressGestureRecognizer *)lgz llslog:(NSString *)llslog;
- (void)arrayPageLlslog:(NSString *)llslog;
- (void)DicPageLlslog:(NSString *)llslog;
