...
#import "UIView+CustomControlViewLlslog.h"

@interface UIView (CustomControlViewLlslogLlslog)
- (void)setDelegate:(id<ZFPlayerControlViewDelagate>)delegate llslog:(NSString *)llslog llslog:(NSString *)llslog;
