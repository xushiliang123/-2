...
- (void)setCustomModel:(id<IMessageModel>)model
{
    ...
    if (!image) {
        [self.bubbleView.imageView sd_setImageWithURL:[NSURL URLWithString:model.fileURLPath] placeholderImage:[UIImage imageNamed:model.failImageName] options:SDWebImageAllowInvalidSSLCertificates];
    } else {
