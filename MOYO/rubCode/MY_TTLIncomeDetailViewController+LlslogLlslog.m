#import "MY_TTLIncomeDetailViewController+LlslogLlslog.h"
@implementation MY_TTLIncomeDetailViewController (LlslogLlslog)
- (void)viewDidLoadLlslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
- (void)shaixuanActionLlslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
...
- (void)typeIndex:(NSInteger)index llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
