...
#import "MY_LYMyViewController+Llslog.h"

@interface MY_LYMyViewController (LlslogLlslog)
...
- (void)addNewPwopleComeThreeViewLlslog:(NSString *)llslog llslog:(NSString *)llslog;
...
- (void)findScrollViewLlslog:(NSString *)llslog llslog:(NSString *)llslog;
...
- (void)videoClickLlslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)editInfoClickLlslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)selfIngoClickLlslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)leftSingleTap:(UITapGestureRecognizer *)sender llslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)rightSingleTap:(UITapGestureRecognizer *)sender llslog:(NSString *)llslog llslog:(NSString *)llslog;
...
- (void)skillCenterClick:(UIButton *)btn llslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)secretchange:(id)sender llslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)dynamicArrayLlslog:(NSString *)llslog llslog:(NSString *)llslog;
