...
+ (void)initialize
{
    ...
    imageView.badgeBackgroudColor = [UIColor clearColor];
...
//        _AddVImg = [[UIImageView alloc] init];
//        _AddVImg.translatesAutoresizingMaskIntoConstraints = NO;
//        _AddVImg.backgroundColor = [UIColor clearColor];
//        _AddVImg.image = [UIImage imageNamed:@"GZ"];
//        [self addSubview:_AddVImg];
        
        [self _setupImageViewConstraint];
//        [self _setupAddVImgConstraint];
...
-(void)_setupAddVImgConstraint
{
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.AddVImg attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.AddVImg attribute:NSLayoutAttributeWidth multiplier:1.0 constant:19]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.AddVImg attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.AddVImg attribute:NSLayoutAttributeHeight multiplier:1.0 constant:19]];
    
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.imageView attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.AddVImg attribute:NSLayoutAttributeBottom multiplier:1.0 constant:0]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.imageView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.AddVImg attribute:NSLayoutAttributeRight multiplier:1.0 constant:0]];
}
...
- (void)_setupBadgeViewConstraint
{
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.badgeView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.imageView attribute:NSLayoutAttributeRight multiplier:1.0 constant:6]];
    
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.badgeView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.imageView attribute:NSLayoutAttributeTop multiplier:1.0 constant:-6]];
}
