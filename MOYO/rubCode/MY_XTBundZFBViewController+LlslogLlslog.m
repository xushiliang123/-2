#import "MY_XTBundZFBViewController+LlslogLlslog.h"
@implementation MY_XTBundZFBViewController (LlslogLlslog)
...
- (void)BundButtonClick:(UIButton *)btn llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
...
- (void)getCodeBtnClickLlslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
