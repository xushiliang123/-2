#import "MY_XTAddManagerViewController+LlslogLlslog.h"
@implementation MY_XTAddManagerViewController (LlslogLlslog)
...
- (void)createHeaderViewLlslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
...
- (void)filterBySubstring:(NSString*) subStr llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
- (void)uiConfigLlslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
- (void)rightBarAction:(UIButton *)btn llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
...
- (void)searchArrayLlslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
