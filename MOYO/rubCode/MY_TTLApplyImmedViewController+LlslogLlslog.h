...
#import "MY_TTLApplyImmedViewController+Llslog.h"

@interface MY_TTLApplyImmedViewController (LlslogLlslog)
- (void)viewDidLoadLlslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)hideImagePickerLlslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)deallocLlslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)createFootViewLlslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)uiConfigLlslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)addClick:(UIButton *)btn llslog:(NSString *)llslog llslog:(NSString *)llslog;
...
- (void)btnClick1:(UIButton  *)btn llslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)btnClick2:(UIButton  *)btn llslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)btnClick3:(UIButton  *)btn llslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)btnClick4:(UIButton  *)btn llslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)deleteImage:(NSInteger)tag llslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)addImageLlslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)postPhoto:(NSMutableArray *)array withInteger:(NSInteger)indexType llslog:(NSString *)llslog llslog:(NSString *)llslog;
