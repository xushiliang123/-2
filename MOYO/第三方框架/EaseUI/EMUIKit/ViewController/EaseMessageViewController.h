 ...
 */
- (UITableViewCell *)messageViewController:(UITableView *)tableView
                       cellForTimeString:(NSString *)timeString;
...
- (void)messageViewController:(EaseMessageViewController *)viewController
  didLongPassSelectAvatarMessageModel:(id<IMessageModel>)messageModel;
...
/*!
 ...
 @result
 */
- (BOOL)messageViewControllerSendMessages:(EaseMessageViewController *)viewController ForMessage:(EMMessage *)message;
@end
...
@property (nonatomic, strong) MY_GLClubModel * groupModel;  //传进来的modle
@property (nonatomic, strong) MY_LYPersonInfoModel *personalModel; //我自己的信息model

@property (nonatomic, strong) MY_LYPersonInfoModel * model; //对方的model
@property (nonatomic, assign)CGFloat changeTableViewY;  //设置tableView的frame 传你添加View的高度
/*!
 @property
 @brief 是否是群聊
 */
...
- (void)insertMessageRefreshWithMessage:(EMMessage *)messageNew;    //手动插入一条消息到本地，刷新列表
/*!
 @method
 @brief 下拉加载更多
 @discussion
