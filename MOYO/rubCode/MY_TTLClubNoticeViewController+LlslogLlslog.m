#import "MY_TTLClubNoticeViewController+LlslogLlslog.h"
@implementation MY_TTLClubNoticeViewController (LlslogLlslog)
...
- (void)rightBarEmptyAction:(UIButton *)emptyBtn llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
...
- (void)agree:(UIButton *)sender llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
- (void)disagree:(UIButton *)sender llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
