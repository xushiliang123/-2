#import "LOtherTableViewCell+LlslogLlslog.h"
@implementation LOtherTableViewCell (LlslogLlslog)
...
- (void)createCellUILlslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
