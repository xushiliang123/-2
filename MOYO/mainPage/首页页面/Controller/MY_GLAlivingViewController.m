...
@interface MY_GLAlivingViewController ()<MY_LLPayViewControllerDelegate,MY_LLChatRedPacketSayHWViewDelegate>
{
    NSInteger _page;
...
@implementation MY_GLAlivingViewController
...
- (void)downLoadData:(NSInteger)page isReshing:(BOOL)isReshing{
    ...
    [TLHTTPRequest MY_postWithBaseUrl:ActiveUsersURL parameters:self.selecteDictionary success:^(NSURLSessionDataTask * _Nonnull task, NSDictionary * _Nonnull data) {
