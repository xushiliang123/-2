...
//    
//    UIBarButtonItem * backItem = [[UIBarButtonItem alloc] initWithCustomView:backItem];

    UIBarButtonItem * backItem = [[UIBarButtonItem alloc] initWithImage:[[UIImage imageNamed:@"EaseUIResource.bundle/back"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStylePlain target:self.navigationController action:@selector(popViewControllerAnimated:)];
    ...
    if (_isSendLocation) {
        ...
        sendButton.titleEdgeInsets = UIEdgeInsetsMake(0, 20, 0, 0);
        
        [sendButton setTitleColor:[UIColor colorWithRed:51 / 255.0 green:51 / 255.0 blue:51 / 255.0 alpha:1.0] forState:UIControlStateNormal];
