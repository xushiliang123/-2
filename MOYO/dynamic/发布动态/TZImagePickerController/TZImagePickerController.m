...
- (void)viewDidLoad {
    ...
    // 默认的外观，你可以在这个方法后重置
    self.oKButtonTitleColorNormal   = [Utility colorWithHexString:@"0096ff" alpha:1.0];
    self.oKButtonTitleColorDisabled = [Utility colorWithHexString:@"0096ff" alpha:0.5];
...
- (void)dealloc{
    NSLog(@"TZImagePickerController--dealloc");
}
@end
