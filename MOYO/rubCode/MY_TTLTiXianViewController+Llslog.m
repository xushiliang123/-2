#import "MY_TTLTiXianViewController+Llslog.h"
@implementation MY_TTLTiXianViewController (Llslog)
...
- (void)createButtonLlslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
- (void)tixianClick:(UIButton *)btn llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
...
- (void)bindClick:(UIButton *)btn llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
