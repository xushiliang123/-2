#import "MY_XTTiXianViewController+LlslogLlslog.h"
@implementation MY_XTTiXianViewController (LlslogLlslog)
...
- (void)submitButtonLlslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
- (void)upLoadDataLlslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
- (void)submitButtonClick:(UIButton*)sender llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
- (void)isPureInt:(NSString*)string llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
- (void)isPureFloat:(NSString*)string llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
- (void)deptNumInputShouldNumber:(NSString *)str llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
...
- (void)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
...
- (void)BundSuccess:(NSNotification *)not llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
