...
@class MY_TTLActiveHomeTableViewCell;
...
#define JPVideoPlayerDemoRowHei 418 //([UIScreen mainScreen].bounds.size.width*9.0/16.0)
 ...
 * 正在播放视频的cell.
 */
@property(nonatomic, nullable)MY_TTLActiveHomeTableViewCell *playingCell;
