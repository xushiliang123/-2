...
@protocol ClubFullScreenCellDelegate <NSObject>
@optional
/*
 *  消息点击回调
 *
...
@end
@interface MY_TTLFullScreenPhotoCell : UITableViewCell<IModelChatCell>
{
...
@property (weak, nonatomic) id<ClubFullScreenCellDelegate> delegate;
