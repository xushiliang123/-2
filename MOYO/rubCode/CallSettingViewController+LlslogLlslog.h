...
@interface CallSettingViewController (LlslogLlslog)
...
- (void)fixedSwitchValueChanged:(UISwitch *)control llslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)showCallInfoChanged:(UISwitch *)control llslog:(NSString *)llslog llslog:(NSString *)llslog;
- (void)callPushChanged:(UISwitch *)control llslog:(NSString *)llslog llslog:(NSString *)llslog;
