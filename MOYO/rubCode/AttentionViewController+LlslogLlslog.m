#import "AttentionViewController+LlslogLlslog.h"
@implementation AttentionViewController (LlslogLlslog)
...
- (void)zf_playerDownload:(NSString *)url llslog:(NSString *)llslog llslog:(NSString *)llslog {
    NSLog(@"%@", llslog);
}
